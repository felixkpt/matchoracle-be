...
const Index = () => {
    ...
    return (
        ...
        <div>
            <PageHeader title={'Competitions list'} action="button" actionText="Create Competition" actionTargetId="competitionModal" permission='dashboard/competitions' setRecord={setRecord} />
                    ...
                    <div className="tab-content" id="competitionTabsContent" key={record?.id}>
                        <div className="tab-pane fade show active" id="manual" role="tabpanel" aria-labelledby="manual-tab">
                            <div className="mt-4 pt-1 border-top">
                                <AutoModalBody modelDetails={modelDetails} listSources={listSources} record={record} setKey={setKey} />
                            </div>
                        </div>
