...
const Sidebar = ({ sidebarExpanded, setSidebarExpanded, pathname }: Props) => {

    const links = [
    ]

    return (<ul className="mb-6 flex flex-col gap-1.5">
        {/* <!-- Menu Item Dashboard --> */}
        <SidebarLinkGroup
            activeCondition={
                            ...
                            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                {links.map(link => (
                                    <li>
                                        <Link
                                            href={link.href}
                                            className='group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white !text-whitee'>
                                            Icon
                                            {link.name}
                                        </Link>
                                    </li>
