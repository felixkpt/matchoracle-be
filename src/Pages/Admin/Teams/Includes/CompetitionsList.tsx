                        ...
                        <div key={competition.id} className=" accordion-item">
                            ...
                            <div id={`collapse${competition.id}`} className="accordion-collapse collapse" aria-labelledby={`heading${competition.id}`}>
                                <div className="m-2 shadow-sm border-top">
                                    <div className="mt-2 d-flex justify-content-end"><NavLink to={`/admin/competitions/view/${competition.id}`} className="link-unstyled shadow rounded m-1 p-2 me-4 hover-grow text-muted"><span className="me-1">Competition info</span><Icon icon={'mdi:arrow-right-bold'} /></NavLink></div>
