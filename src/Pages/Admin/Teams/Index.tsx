                    ...
                    <div className="accordion-item mb-1" key={country.id}>
                        ...
                        <div id={`collapse${country.id}`} className="accordion-collapse collapse" aria-labelledby={`#heading${country.id}`}>
                            <div className="accordion-body">
                                <div className="d-flex justify-content-end"><NavLink to={`/admin/countries/view/${country.id}`} className="link-unstyled shadow rounded m-1 p-2 hover-grow text-muted"><span className="me-1">Country competitions info</span><Icon icon={'mdi:arrow-right-bold'} /></NavLink></div>
