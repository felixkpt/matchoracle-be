...
const Settings = ({ post, files, setFiles, statuses }: Props) => {
    ...
    useEffect(() => {
        fetchSelectData(`dashboard/posts/categories?all=1&id=${queryParams.get('category_id') || '0'}`, setCategories);
    }, []);
                                ...
                                <div className='form-control' id='category_id'>
                                    <Select
                                        ...
                                        onChange={(newValue) => {
                                            ...
                                            handleSelectChange(
                                                { uri: `dashboard/posts/categories/topics?all=1`, fn: setTopics },
                                                [
