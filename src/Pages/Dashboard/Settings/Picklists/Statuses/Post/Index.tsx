  ...
  return (
    <div>
      ...
      <div>
        ...
        <AutoTable
          baseUri='/dashboard/settings/picklists/statuses/post'
          columns={[
            {
              label: 'ID',
              key: 'id',
      ...
      {
        modelDetails && <><AutoModal id={`Statuses`} modelDetails={modelDetails} actionUrl='/dashboard/settings/picklists/statuses/post' /></>
      }
    </div>
  );
};
