  ...
  return (
    <div>
      ...
      <div>
        ...
        <AutoTable
          baseUri='/dashboard/settings/picklists/statuses/default'
          columns={[
            {
              label: 'ID',
              key: 'id',
      ...
      {
        modelDetails && <><AutoModal id={`Statuses`} modelDetails={modelDetails} actionUrl='/dashboard/settings/picklists/statuses/default' /></>
      }
    </div>
  );
};
