...
const BettingTipsStats = ({ loading, errors, stats }: Props) => {
            ...
            <div className="card card-primary">
                <div className="card-header">
                    <h5 className='d-flex align-items-center gap-1'>
                        ...
                        <span>Betting tips stats {stats ? `in ${localStats[0]?.range}` : ''}</span>
                    </h5>
                </div>
                                    ...
                                    errors || !stats ?
                                        ...
                                        <div className="col-12 mb-4">
                                            ...
                                            <div className="row justify-content-end">
                                                <NavLink to={'/dashboard/betting-tips/stats'}><button className='btn btn-outline-dark w-100'>View More</button></NavLink>
                                            </div>
                                        </div>
                                }
                            </>
