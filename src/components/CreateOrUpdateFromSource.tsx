...
const CreateOrUpdateFromSource = ({ record, hideClose }: Props) => {
    ...
    return (
        <div>
            ...
            <div className="modal-footer gap-1">
                ...
                <button type="button" className="btn btn-primary from-source-submit-button">Submit</button>
            </div>
        </div>
    )
}

export default CreateOrUpdateFromSource