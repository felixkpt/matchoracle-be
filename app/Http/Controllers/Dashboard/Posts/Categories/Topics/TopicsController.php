                ...
                return '
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item autotable-view" data-id="' . $item->id . '" href="/dashboard/posts/categories/topics/view/' . $item->id . '">View</a></li>
                            '
                    .
                    (checkPermission('docs.categories.topics', 'post') ?
                        '<li><a class="dropdown-item autotable-edit" data-id="' . $item->id . '" href="/dashboard/posts/categories/topics/' . $item->id . '">Edit</a></li>'
                        :
                        '')
                    .
                    '
                            <li><a class="dropdown-item autotable-update-status" data-id="' . $item->id . '" href="/dashboard/posts/categories/' . $item->id . '/topics/view/' . $item->id . '/update-status">Status update</a></li>
                        </ul>
                    </div>
                    ';
            })
