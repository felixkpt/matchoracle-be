...
class GGTips
{
    ...
    function singles()
    {
        ...
        $results = $results->whereHas('prediction', fn ($q) => $q->where($this->proba_name, '>=', $this->proba_threshold)->where($this->proba_name2, '>', $this->proba2_threshold));
